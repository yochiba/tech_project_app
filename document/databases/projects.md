...
|9|environment|text|開発環境|YES|||
|10|weekly_attendance|integer|出勤回数(日/週)|YES|||
|11|min_operation_unit|integer|最低稼働|YES|||
|12|max_operation_unit|integer|最大稼働|YES|||
|13|operation_unit_id|integer|稼働単位ID|YES|||
|14|operation_unit|string|稼働単位|YES|||
|15|min_price|integer|最小単価|YES||単位は円|
|16|max_price|integer|最大単価|YES||単位は円|
|17|price_unit_id|integer|単価単位ID|YES|||
|18|location_id|integer|ロケーションID|YES|||
|19|contract_id|integer|契約形態ID|YES|||
